...
public class PetRegistry implements AutoCloseable {
    ...
    public static void main(String[] args) throws Exception {
        try (PetRegistry petRegistry = new PetRegistry()) {
            ...
            while (true) {
                ...
                System.out.println("2. Обучить животное выполнению команд");
                System.out.println("3. Отдать команду");
    ...
    public void close() throws Exception {
        if (counter.getCount() == 0) {
            throw new Exception("Счетчик не был использован в блоке try-with-resources");
        } else {
            counter.resetCount();
        }
    }
